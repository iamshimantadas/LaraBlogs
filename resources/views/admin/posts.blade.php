...
<div class="app-content">
  ...
  <br>
   ...
   <div class="row">
	 <div class="col-1"></div>
	 <div class="col-10">
	  <p class="text-center fs-4">Add New Post</p>
    <br>
	 <!-- enter your form content -->
	 <form action="{{url('/')}}/admin_newpost_req" enctype="multipart/form-data" method="post">
    @csrf
<div class="mb-3">
    <label for="postname" class="form-label" style="color:black;">Post's Name (Title)</label><span style='color:red;font-size:20px;'>&#42;</span>
    <input type="text" class="form-control" name="postname" id="postname" value="{{old('postname')}}" aria-describedby="enter post's name... " required>
  @error('postname')
  ...
  <select class="form-select" name="postCategoryid" id="postCategoryid" value="{{old('postCategoryid')}}" aria-label="Choose post's category" required>
 @foreach($cat as $cat)
...
<div class="image-preview-container">
    ...
    <input type="file" name="file-upload1" id="file-upload1" accept="image/png, image/gif, image/jpeg" onchange="previewImage(event);" required />
    @error('file-upload1')
  <span style='color:red;'>{{$message}}</span>
  @enderror
  </div>
...
<input type="text" placeholder="Enter thumbnail image's caption..." name="thumbimgcap" id="thumbimgcap" value="{{old('thumbimgcap')}}" class="form-control" required>
@error('thumbimgcap')
  <span style='color:red;'>{{$message}}</span>
  @enderror
</div>
...
<div class="mb-3">
  ...
  <br>
  <textarea name="bodycontent1" id="bodycontent1" value="{{old('bodycontent1')}}" cols="30" rows="10" required></textarea>
  @error('bodycontent1')
  <span style='color:red;'>{{$message}}</span>
  @enderror
</div>
...
<div class="image-preview-container">
    ...
    <input type="file" name="file-upload2" id="file-upload2" accept="image/png, image/gif, image/jpeg" onchange="previewImage2(event);" required />
    @error('file-upload2')
  <span style='color:red;'>{{$message}}</span>
  @enderror
  </div>
...
<input type="text" placeholder="Enter first paragraph image's caption..." name="bodycontent1imgcap" id="bodycontent1imgcap" value="{{old('bodycontent1imgcap')}}" class="form-control" required>
...
<div class="mb-3">
  ...
  <br>
  <textarea name="bodycontent2" id="bodycontent2" value="{{old('bodycontent2')}}" cols="30" rows="10" required></textarea>
  @error('bodycontent2')
  <span style='color:red;'>{{$message}}</span>
  @enderror
</div>
...
<input type="text" placeholder="Enter second paragraph image's caption..." name="bodycontent2imgcap" id="bodycontent2imgcap" value="{{old('bodycontent2imgcap')}}" class="form-control">
</div>
...
<div class="mb-3">
  ...
  <br>
  <textarea name="bodycontent3" id="bodycontent3" value="{{old('bodycontent3')}}" cols="30" rows="10"></textarea>
</div>
<div class="mb-3">
...
<input type="text" placeholder="Enter third paragraph image's caption..." name="bodycontent3imgcap" id="bodycontent3imgcap" value="{{old('bodycontent3imgcap')}}" class="form-control">
</div>
...
<div class="mb-3">
  ...
  <br>
  <textarea name="bodycontent4" id="bodycontent4" value="{{old('bodycontent4')}}" cols="30" rows="30"></textarea>
</div>
<div class="mb-3">
...
<input type="text" placeholder="Enter fourth paragraph image's caption..." name="bodycontent4imgcap" id="bodycontent4imgcap" value="{{old('bodycontent4imgcap')}}" class="form-control">
</div>
...
<input type="text" class="form-control" name="youtubevid" id="youtubevid" value="{{old('youtubevid')}}"> 
</div>
...
<select class="form-select" name="postVisBility"  id="postVisBility" value="{{old('postVisBility')}}" aria-label="select post's visibility to public/draft">
...
<br>
     ...
     <input type="hidden" name="adminid" id="adminid" value="{{$admin->adminid}}" required>
     @endforeach
...
<script>
  $(document).ready(function(){
    $('#postname').blur(function(){
     ...
     $.ajax({
      url:"{{route('adminpostnameexist')}}",
      method:"GET",
      data:{postname:postname,_token:_token},
